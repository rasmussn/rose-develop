...
# Thus JAVAH has been removed starting with the following line [Rasmussen 2019.04.30]
#
...
# LDFLAGS="-Xlinker -rpath ${JAVA_HOME}/lib/server"
...
# LDFLAGS="-Xlinker -rpath ${JAVA_HOME}/lib/server $LDFLAGS"

# AM_COND_IF([OS_MACOSX],[JAVA_JVM_INCLUDE="-I${JAVA_PATH}/include -I${JAVA_PATH}/include/darwin"],[JAVA_JVM_INCLUDE="-I${JAVA_PATH}/include -I${JAVA_PATH}/include/linux"])
# Rasmussen test of OpenJDK
